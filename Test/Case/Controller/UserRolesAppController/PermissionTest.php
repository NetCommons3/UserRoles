 ...
 */
class UserRolesAppControllerPermissionTest extends NetCommonsControllerTestCase {
 ...
 */
	public function testPermission($role, $exception) {
		...
		//テスト実行
		$this->_testNcAction('/test_user_roles/test_user_roles_app_controller_permission/index', array(
			'method' => 'get'
		));
