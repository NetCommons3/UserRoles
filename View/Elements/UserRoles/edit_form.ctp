...
<?php echo $this->Form->hidden($langId . '.' . 'UserRole.id'); ?>

<?php echo $this->Form->hidden($langId . '.' . 'UserRole.key'); ?>

<?php echo $this->Form->hidden($langId . '.' . 'UserRole.language_id'); ?>

<?php echo $this->Form->hidden($langId . '.' . 'UserRole.type'); ?>

<div class="form-group">
	<?php echo $this->Form->input($langId . '.' . 'UserRole.name', array(
			'type' => 'text',
